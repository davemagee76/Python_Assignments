...
def generate_mol_dict(ions):
    ...
    # loop through each list in the ions variable; for each pair of elements assign the first element to a variable
    # called 'key' and the second variable called 'value'
    # return the mol_dict
...
with open(sys.argv[1], 'r') as fin, open(sys.argv[2], 'w') as fout:
    ...
    for line in fin:
        ...
        if "?" in data:
            ...
            # the calc_compound_mol_weight function
    ...
    # Solve for mass
            if mass == "?":
                ...
                # print((str(data)[1:-1]),'\n',str(grams)[0] + str(data)[1:-1])
                fout.write("input   {}\noutput   {}{}\n".format(data[1:-1],list(grams),(data)[2:-1]))

                #fout.write("{}\n".format(data[0:])+"{}\n".format(grams,data[1:]))
                #fout.write("input={} output{}\n".format(data[0:], grams[0:]))
